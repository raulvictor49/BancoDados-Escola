-- =============================================================
-- LIMPEZA DOS DADOS ANTERIORES (ordem inversa das FKs)
-- =============================================================
DELETE FROM OFERECE;
DELETE FROM ESTA_MATRICULADO;
DELETE FROM CURSA;
DELETE FROM RESPONSAVEL_ATIVIDADES;
DELETE FROM HISTORICO_DISCIPLINA;
DELETE FROM HISTORICO_GERAL;
DELETE FROM CURSO_EXTRACURRICULAR;
DELETE FROM DISCIPLINA;
DELETE FROM EX_ALUNO;
DELETE FROM ALUNO;
DELETE FROM ALUNO_MONITOR;
DELETE FROM ADMINISTRATIVO;
DELETE FROM PROFESSOR_DISCIPLINA;
DELETE FROM PROFESSOR;
DELETE FROM TELEFONE_FUNC;
DELETE FROM FUNCIONARIO;
DELETE FROM TURMA;
DELETE FROM DEPARTAMENTO;
DELETE FROM PESSOA;

-- Resetar sequências dos campos SERIAL
ALTER SEQUENCE historico_geral_id_hist_geral_seq RESTART WITH 1;
ALTER SEQUENCE historico_disciplina_id_hist_disc_seq RESTART WITH 1;

-- =============================================================
-- POPULAÇÃO. ESCOLA ESTADUAL PROFESSOR ANÍSIO TEIXEIRA
-- =============================================================
